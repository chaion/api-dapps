...
public class EthServiceTest {
    ...
    @Test
    public void validateEthTx() throws BlockchainException {
        ...
        ethService.validateEthTx(txHash, from, to, amount, (a1, a2) -> true);
    }

    @Test
    public void validateEthTx2() throws BlockchainException {
    ...
    @Test
    public void validateERC20Tx() throws BlockchainException {
        ...
        ethService.validateERC20Transaction(txHash, from, to, token, amount, null);
    }
